...
eem_metatemplate(eem_list, absorbance) %>%
  write.csv(file="C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/metatable.csv", row.names = FALSE)

meta = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/metatable_dreem.csv", row.names = 1)
...
absorbance = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/CorrectedAbundance_mod.csv", header = T)
...
write.csv(indices_peaks, file = "C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/indices_peaks.csv", row.names = FALSE)
...
#tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/Figures/DOM_peaks.tiff", units = "in", height = 6, width = 20, res = 120)
#last_plot()
#dev.off()
...
write.csv(slope_parms, file = "C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/absorbance_slopes.csv", row.names = FALSE)
...
#tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/Figures/DOM_slopes1.tiff", units = "in", height = 10, width = 20, res = 120)
#last_plot()
#dev.off()
...
#tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/Figures/DOM_slopes2.tiff", units = "in", height = 10, width = 20, res = 120)
#last_plot()
#dev.off()
...
#tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/Figures/DOM_slopes3.tiff", units = "in", height = 10, width = 20, res = 120)
#last_plot()
#dev.off()
...
eempf_comp_load_plot(pf4[[2]], contour = TRUE)
pf4[[2]]
#pf4 = pf4_RawBU
#pf4 = pf4_BU
#Extract dataframe
...
tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/Figures/Intensity.tiff", units = "in", width = 7, height = 6, res = 120)
last_plot()
dev.off()
...
#Save plot
pdf("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/Figures/Model4CompResid.pdf", width = 12, height = 8)
picture.plt
dev.off()
...
eempf_openfluor(pf4[[1]], file = "c:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/4component_model_openfluor.txt")
...
tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/EEM_PARAFAC/R_Analysis/Figures/PCA_DOM_peaks_contributionVar.tiff", units = "in", height = 5, width = 6, res = 120)
last_plot()
dev.off()
