...
setwd("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/")
...
```{r Import CHN data}
#Import dataframes
CHN1.raw = readxl::read_excel("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/Raw_Nov2021_Febr2022_CHNAnalysis.xlsx")
CHN2.raw = readxl::read_excel("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/Raw_SvenMayJunNov2022.xlsx")
...
CHN.meta = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/POCPTCPIC_Metadata.csv", sep = ",")
...
SYBR_sum.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/AllSYBR_Summary.csv", header = T, fileEncoding = "UTF-8-BOM")
...
TEP and CSP particle area per L = left axis & Particle and CSP % per particles = right axis
Facet by season
Colour = different fractions (suspended vs sinking)
...
Merged_Fig1B.df = merge(TEPCSP_AreaL.df, TEP_CSP_sum2.df, by = c("Station", "Condition", "Date", "Fraction"))



#Rename date column for compliance with other code
Merged_Fig1B.df$Sample_date = Merged_Fig1B.df$Date
Merged_Fig1B.df$Date = NULL


#Fix date format for easier plotting
Merged_Fig1B.df$Sample_date = gsub("2021.07", "Jul-21", Merged_Fig1B.df$Sample_date)
Merged_Fig1B.df$Sample_date = gsub("2021.11", "Nov-21", Merged_Fig1B.df$Sample_date)
Merged_Fig1B.df$Sample_date = gsub("2022.02", "Feb-22", Merged_Fig1B.df$Sample_date)
Merged_Fig1B.df$Sample_date = gsub("2022.05", "May-22", Merged_Fig1B.df$Sample_date)
Merged_Fig1B.df$Sample_date = gsub("2022.06", "Jun-22", Merged_Fig1B.df$Sample_date)
Merged_Fig1B.df$Sample_date = gsub("2022.11", "Nov-22", Merged_Fig1B.df$Sample_date)

Merged_Fig1B.df$Season = factor(Merged_Fig1B.df$Sample_date,
                                              levels = c("Spring",
                                                         "Summer-21",
                                                         "Summer-22",
                                                         "Autumn",
...
Merged_Fig1B.df$Season = Merged_Fig1B.df$Sample_date
Merged_Fig1B.df$Season = gsub("Jul-21", "Summer-21", Merged_Fig1B.df$Season)
Merged_Fig1B.df$Season = gsub("Nov-21", "Autumn", Merged_Fig1B.df$Season)
Merged_Fig1B.df$Season = gsub("Feb-22", "Winter", Merged_Fig1B.df$Season)
Merged_Fig1B.df$Season = gsub("May-22", "Spring", Merged_Fig1B.df$Season)
Merged_Fig1B.df$Season = gsub("Jun-22", "Summer-22", Merged_Fig1B.df$Season)
Merged_Fig1B.df$Season = gsub("Nov-22", "Autumn", Merged_Fig1B.df$Season)

Merged_Fig1B.df$Season = factor(Merged_Fig1B.df$Season,
                                              levels = c("Spring",
                                                         "Summer-21",
                                                         "Summer-22",
                                                         "Autumn",
...
Merged_Fig1B.df$Sample_date = factor(Merged_Fig1B.df$Sample_date,
                                              levels = c("Jul-21",
                                                         "Feb-22",
                                                         "May-22",
                                                         "Jun-22",
...
Merged_Fig1B.df$Fraction = factor(Merged_Fig1B.df$Fraction,
                                              levels = c("Suspended",
                                                         "Sinking"))
...
Merged_Fig1B.df = subset(Merged_Fig1B.df, Sample_date!="Nov-21" & Sample_date!="Jul-21")


Figure1B.plot = ggplot(Merged_Fig1B.df, aes(x=Stromkilometer, 
                                       fill = Fraction, 
                                       group = Fraction)) +
...
#tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Poster/TEPCSP_ParticleConcperL_Perc.tiff", units = "cm", width = 24, height = 18, res = 120)
#Figure1B.plot
#dev.off()

pdf("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Poster/TEPCSP_ParticleConcperL_Perc.pdf", height = 7, width = 18)
Figure1B.plot
dev.off()
...
Merged_Fig1B_TEP.df = subset(Merged_Fig1B.df, Condition=="TEP")
Merged_Fig1B_CSP.df = subset(Merged_Fig1B.df, Condition=="CSP")

cor.test(Merged_Fig1A.df$CorrAreaL[-13], Merged_Fig1B_TEP.df$ConditionPerc, method = "p")
cor.test(Merged_Fig1A.df$CorrAreaL[-c(13,15)], Merged_Fig1B_CSP.df$ConditionPerc, method = "p")
...
####Prepare df####
Physico_para.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/PhysicochemicalParameters_mod_BU.txt", encoding = "UTF-8", sep = "\t")
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/Salinity.png", units = "in", width = 6, height = 4, res = 150)
Salinity.plt
dev.off()
...
####Prepare df####
Physico_para.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/PhysicochemicalParameters_mod.txt", encoding = "UTF-8", sep = "\t")
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/Turbidity.png", units = "in", width = 6, height = 4, res = 150)
Turbidity.plt
dev.off()
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/SalinityTurbidity.png", units = "in", width = 14, height = 4, res = 150)
...
Need SPM = left axis & Particle Area (only unstained) = right axis
Facet by season
Colour = different fractions (suspended vs sinking)
...
#Merge two dataframes
Merged_Fig1A.df = merge(Particle_physico_para.df, Particle_sum.df, by = c("Station", "Stromkilometer", "Sample_date", "Fraction"))


#Add seasonal date to dataframe and reorder
#Merged_Fig1A.df$Season = Merged_Fig1A.df$Sample_date
#Merged_Fig1A.df$Season = gsub("Jul-21", "Summer", Merged_Fig1A.df$Season)
#Merged_Fig1A.df$Season = gsub("Nov-21", "Autumn", Merged_Fig1A.df$Season)
#Merged_Fig1A.df$Season = gsub("Feb-22", "Winter", Merged_Fig1A.df$Season)
#Merged_Fig1A.df$Season = gsub("May-22", "Spring", Merged_Fig1A.df$Season)
#Merged_Fig1A.df$Season = gsub("Jun-22", "Summer", Merged_Fig1A.df$Season)
#Merged_Fig1A.df$Season = gsub("Nov-22", "Autumn", Merged_Fig1A.df$Season)

#Merged_Fig1A.df$Season = factor(Merged_Fig1A.df$Season,
 #                                             levels = c("Spring",
  #                                                       "Summer",
   #                                                      "Autumn",
    #                                                     "Winter"))
...
#Set order to consistency
Merged_Fig1A.df$Fraction = factor(Merged_Fig1A.df$Fraction,
                                              levels = c("Suspended",
                                                         "Sinking"))
...
#Remove November 2021 Land cruise 
Merged_Fig1A.df = subset(Merged_Fig1A.df, Sample_date!="Nov-21" & Sample_date!="Jul-21")

Figure1A.plot = ggplot(Merged_Fig1A.df, 
                       aes(x=Stromkilometer, 
                           fill = Fraction, 
                           group = Fraction)) +
...
#Save plot
#tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Poster/Dryweight_ParticleConc_perL.tiff", units = "in", width = 9, height = 7, res = 120)
#Figure1A.plot
#dev.off()

pdf("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Poster/Dryweight_ParticleConc_perL.pdf", height = 7, width = 9)
Figure1A.plot
dev.off()
```
...
cor.test(as.numeric(Merged_Fig1A.df$SPM_mgperL), Merged_Fig1A.df$CorrAreaL, method = "spearman")

Merged_Fig1A_Sus.df = subset(Merged_Fig1A.df, Fraction == "Suspended")
cor.test(as.numeric(Merged_Fig1A_Sus.df$SPM_mgperL), Merged_Fig1A_Sus.df$CorrAreaL, method = "spearman")
Merged_Fig1A_Sink.df = subset(Merged_Fig1A.df, Fraction == "Sinking")
cor.test(as.numeric(Merged_Fig1A_Sink.df$SPM_mgperL), Merged_Fig1A_Sink.df$CorrAreaL, method = "spearman")


#Area to salinity?

#Significant dry weight over salinity - SPM
cor.test(as.numeric(Merged_Fig1A.df$SPM_mgperL), as.numeric(Merged_Fig1A.df$Salinity), method = "s")
#Significant particle concentration over salinity - Particle conc.
cor.test(as.numeric(Merged_Fig1A.df$CorrAreaL), as.numeric(Merged_Fig1A.df$Salinity), method = "s")

#To temperature?
#Significant dry weight over salinity - SPM
cor.test(as.numeric(Merged_Fig1A.df$SPM_mgperL), as.numeric(Merged_Fig1A.df$Temperature), method = "s")
#Significant particle concentration over salinity - Particle conc.
cor.test(as.numeric(Merged_Fig1A.df$CorrAreaL), as.numeric(Merged_Fig1A.df$Temperature), method = "s")
...
Physico_para.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/PhysicochemicalParameters.csv")
...
#Import dataframes
SYBR_sum.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/AllSYBR_Summary.csv")
...
###PAO biomass
With and without TEP/CSP associated organisms
```{r}
#Import dataframe
PAO.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/AllColonisation_Summary.csv")
...
TC_mgperL.plt = ggplot(C_Elbe.sum, aes(x = Station, y = C_mgperL, colour = Organic, group = Groups))+
  geom_line(aes(linetype = Fraction), size = 1)+
  geom_point(size = 5)+
  facet_grid(Date ~ .)+
  scale_color_manual("Carbon type", values = cbbPalette)+
...
#Save plot
tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/TotalCarbon.tiff", units = "in", width = 12, height = 12, res = 120)
TC_mgperL.plt
dev.off()

pdf("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Poster/TotalCarbon.pdf", height = 7.08661, width = 9.44882)
TC_mgperL.plt
dev.off()
...
tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/Figure5_CarbonContribution.tiff", height = 7, width = 9, units = "in", res = 120)
last_plot()
dev.off()

png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/Figure5_CarbonContribution.png", height = 7, width = 9, units = "in", res = 120)
last_plot()
dev.off()
...
#Save plot
tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/Figure6_TotalCarbonPerc.tiff", units = "in", width = 16, height = 10, res = 120)
TC_Contribution_All.plt
dev.off()

png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/Figure6_TotalCarbonPerc.png",  units = "in", width = 16, height = 10, res = 120)
TC_Contribution_All.plt
dev.off()
...
colnames(Merged_Fig1B.df)
dim(Merged_Fig1B.df)


TEPvsCSP.df = spread(Merged_Fig1B.df[,c(1:3,5,14:15)], Condition, CorrAreaL)
...
SYBR.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/AllSYBR_Summary.csv")
...
#Save plot
#tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Poster/TEPCSPvsPAO.tiff", units = "in", width = in, height = 9, res = 120)
#last_plot()
#dev.off()

#Save plot
pdf("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Poster/TEPCSPvsPAO.pdf", height = 7, width = 9)
last_plot()
dev.off()

####Test Alternative####

ggplotRegression(lm(TEP ~ PAO_perL, data = StainsVsPAO.df))
ggplotRegression(lm(CSP ~ PAO_perL, data = StainsVsPAO.df))
...
colnames(Merged_Fig1A.df)
dim(Merged_Fig1A.df)


ParticleArea.df = Merged_Fig1A.df[,c(1:3,8)]
...
#Save plot
tiff("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/DirectComparisons.tiff", units = "in", width = 16, height = 8, res = 120)
Comparisons.plt
dev.off()
...
FalseDiscovery_sum.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/AllFalseDiscovery_Summary.csv")
...
FalseDiscovery_sum_Control_ab.plot = ggplot(False_and_True.df, aes(y = Count, x = Station, colour = Condition, group = Condition)) +
  geom_smooth()+
  #scale_y_log10()+
  facet_grid(. ~ Fraction)+
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/SupplementaryFigure1.png", units = "in", width = 12, height = 8, res = 120)
FalseDiscovery_sum_Control_ab.plot
dev.off()
...
```{r}
#Import data
Discharge.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/riverdischarge_Neudarchau.csv", sep = ";")
head(Discharge.df)
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/SupplementaryFigure6_Elbe dischargerate.png", units = "in", width = 7, height = 5, res = 150)
last_plot()
dev.off()
...
Physico_para.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/PhysicochemicalParameters.csv", encoding = "UTF-8")
Particle_physico_para.df = unique(Physico_para.df[,c(4:8,10,11,15)])
...
Particle_physico_para.df$Date = gsub("May 21", "2021.05", Particle_physico_para.df$Date)
Particle_physico_para.df$Date = gsub("Jul 21", "2021.07", Particle_physico_para.df$Date)
Particle_physico_para.df$Date = gsub("Feb 22", "2022.02", Particle_physico_para.df$Date)
Particle_physico_para.df$Date = gsub("May 22", "2022.05", Particle_physico_para.df$Date)
Particle_physico_para.df$Date = gsub("Jun 22", "2022.06", Particle_physico_para.df$Date)
Particle_physico_para.df$Date = gsub("Nov 22", "2022.11", Particle_physico_para.df$Date)
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/SupplementaryFigure5_C2SPM.png", units = "in", width = 12, height = 12, res = 150)
last_plot()
dev.off()
...
##Supplementary Figure 5 - DOP & SRP 
###Dissolved organic phosphate

```{r}

####Prepare df####
Physico_para.df = read.csv("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Data/PhysicochemicalParameters_mod.txt", encoding = "UTF-8", sep = "\t", header = T)
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/FigureS4.png", units = "in", width = 12, height = 4, res = 150)
last_plot()
dev.off()
...
##Supplementary Figure 6 - PAH contamination in Elbe 

```{r}

Cuxhaven_PAH.df = read.csv("C:/Users/hunefeldt/Downloads/dbe_gast_20230926_083305708.csv", sep = ";")
Grauerort_PAH.df = read.csv("C:/Users/hunefeldt/Downloads/dbe_gast_20230926_083658214.csv", sep = ";")
Seemanshoft_PAH.df = read.csv("C:/Users/hunefeldt/Downloads/dbe_gast_20230926_082911439.csv", sep = ";")
...
test = FGG_Elbe_PAH.df %>% 
    separate(Date, c("Year","Month", "Day"), sep = "-") 

test$X.Messwert.
test$X.Messwert. = gsub(',', '.', test$X.Messwert.)
test$X.Messwert.
test$X.Messwert.[] <- as.numeric(test$X.Messwert.)
test$X.Messwert.[is.na(test$X.Messwert.)] <- 0
test$X.Messwert.
...
ggplot(test, aes(x=Month, y = X.Messwert., colour = X.Parameter., group = X.Parameter.))+
  geom_line()+
...
png("C:/Users/hunefeldt/OneDrive/Desktop/PhD/R_analysis/ParticleAnalysis/Manusript_Figures/SupplementaryFigure4_PAH.png", units = "in", width = 20, height = 20, res = 150)
last_plot()
dev.off()
```
